...
Record this in one take. Open on the flag in the first fifteen seconds.
...
| 1:25 | Close on landing or README | "Redline is small on purpose so the verdict can be checked, not trusted." |
